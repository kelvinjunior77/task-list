<template>
    ...
    <div v-if="isLoading"
        ...
        <div class="text-center space-y-4">
            ...
            <p class="text-lg font-medium text-gray-700 animate-pulse">Chargement...</p>
        </div>
    </div>
    ...
    <div v-show="!isLoading"
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 sm:mb-8">
                <div>
                    <h1 class="flex items-center gap-2 text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900">
                        ...
                        <span
                            class="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Mes tâches</span>
                    </h1>
            ...
            <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
                <h2 class="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4">Ajouter Une Nouvelle Tâche</h2>
                    ...
                    <div class="p-4 sm:p-6 flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div
                                ...
                                <span>Créé en: {{ formatDate(task.createdAt) }}</span>
                                <span v-if="task.completed">Terminé le: {{ formatDate(task.updatedAt) }}</span>
                            </div>
                        </div>
            ...
            <div v-else class="bg-white rounded-lg shadow-md p-6 sm:p-8 text-center">
                ...
                <h3 class="mt-3 sm:mt-4 text-lg font-medium text-gray-900">Aucune tâche trouvée</h3>
            ...
            <div v-if="isEditing"
                ...
                <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl font-semibold text-gray-800">Modifier La Tâche</h2>
                    ...
                    <form @submit.prevent="saveEditedTask" class="space-y-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="edit-completed" class="ml-2 block text-sm text-gray-700">Complété</label>
                        </div>
            ...
            <div v-if="showAboutModal"
                ...
                <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl font-semibold text-gray-800">À propos de l'application</h2>
                    ...
                    <div class="space-y-4">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 mb-2">Gestionnaire de tâches personnelles</h3>
